...
import ProfessorSidebar from '../components/chat/ProfessorSidebar';
  ...
  return (
    <div className="max-w-[1440px] mx-auto flex gap-6">
      ...
      <div className="flex-1">
        <div className="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden h-[80vh] flex flex-col">
          <ChatHeader />
